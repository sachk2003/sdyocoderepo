                	  ...
                	  var i=1;
                	    ...
                	    tpj.each(data, function(index, element) {
                               ...
                               case 2: 
                                       ...
                                       if(element.link!=null) {var alink= '<a href='+element.link+' style="color:blue;" target="_blank">'+element.link+'</a>';tpj('#'+upccode+' #url').append(alink);} 
  ...
  content: function()
	...
	function getvendorinformation(upcid)
	{
		...
		tpj.ajax({
                ...
                type: "POST",
                url: '/scripts/getvendorinfo.php?upcid='+upcid,
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                async:false,
                success: function(data){
