<html><!-- #BeginTemplate "/Templates/superdealyo_general_template.dwt" -->
<head>
<!-- #BeginEditable "doctitle" --> 
<title>SuperDealyo</title>
<!-- #EndEditable -->
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<link href="http://superdealyo.com/superdealyo.rss" rel="alternate" type="application/rss+xml" title="SuperDealyo News" />
...
<table width="80%" border="0" height="197">
  <tr align="left" valign="top"> 
    <th width="80%" bordercolor="#999999" bgcolor="#FFFFFF" height="1"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Results of Your Search for Deals by Vendor and Zip Code are Shown Here</font></th>
  </tr>
  <tr align="left" valign="top"> 
    <td width="80%" height="299" bordercolor="#999999">
...
echo "<b>Company URL:</b> $companyurl<br>";
echo "<b>Phone:</b> $phone<br>";
echo "<br>";
//echo "<b>Category and Sub-categories</b><br>";
...
echo "<br>";
echo "<b>Discount and Special Offerings</b><br>";
echo "<br><br>";
?></font> </p>
      <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#999999">
        ...
        <tr> 
          ...
          <td width="25" bordercolor="#999999"><a href="http://pod.opendatasoft.com/explore/embed/dataset/pod_gtin/?tab=table&q=<?php echo $array[0]['upc']; ?>" target="_blank"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#0000FF"><?php echo  $array[0]['upc'];?></font></td>
...
<td width="25" bordercolor="#999999"><a href="http://pod.opendatasoft.com/explore/embed/dataset/pod_gtin/?tab=table&q=<?php echo $array[1]['upc']; ?>" target="_blank"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#0000FF"><?php echo  $array[1]['upc'];?></font></td>
        ...
        <tr> 
          ...
          <td width="25" bordercolor="#999999"><a href="http://pod.opendatasoft.com/explore/embed/dataset/pod_gtin/?tab=table&q=<?php echo $array[2]['upc']; ?>" target="_blank"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#0000FF"><?php echo  $array[2]['upc'];?></font></td>
...
<table width="100%" border="0" height="1%">
  <tr bgcolor="6699FF"> 
    <td width=" " height="9">
      <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#FFFFFF"> 
        <a href="vendor.html" target="_blank"> </a> <a href="../about/about.html" target="_blank">About</a> 
        <a href="../career/career.html" target="_blank">Career</a> <a href="../privacy/privacy.html" target="_blank">Privacy</a> 
        <a href="../help/help.html" target="_blank">Help</a></font></div>
    </td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td width=" " height="9"> 
<div align="center"><a href="http://www.facebook.com/pages/superdealyo"><img src="../images/facebook.JPG" width="20" height="20"></a><a href="http://twitter.com/superdealyo"><img src="../images/twitter.JPG" width="20" height="20"></a><a href="../superdealyo.rss"><img src="../images/RSS.JPG" width="20" height="20"></a></div>    
</td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td width=" " height="9"> 
