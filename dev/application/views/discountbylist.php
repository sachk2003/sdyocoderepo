      ...
      <div class="caption">
        ...
        <p>
        	<div class="vendor">
        		...
        		<tr><td colspan="4"><a target="_blank" href="<?php if($discounts[$n][0][8]!='') echo $discounts[$n][0][8];else echo '#'?>" style="color:blue;"><?php if($discounts[$n][0][8]!="") echo $discounts[$n][0][8]; else echo 'Link not found';?></a></td></tr>
