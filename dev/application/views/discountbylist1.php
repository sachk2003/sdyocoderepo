...
{   for($m=0;$m<$upccount;$m++)
	...
	{  
	  ...
	  <div class="row">
		...
		{  //echo "in Loop".$n."max:".$max."maxdiscount: ".$maxdiscount.'<br/>';
			  if($maxdiscount>$max) $max=$maxdiscount;
		   $maxdiscount=0;$norec=0;
		
	 ?>
	 
  <div class="col-md-2" id="<?php echo $upcids[$n];?>">
    <div class="thumbnail">
        ...
        <p>
        	<div class="vendor">
        		...
        		<table class="borderless"><tbody>
        			<tr><td colspan="4"><a target="_blank" href="<?php echo $discounts[0][1][8];?>" style="color:blue;"><?php echo $discounts[0][1][8];?></a></td></tr>
   ...
   <input name="maxcount" type="hidden" id="maxcount" value="<?php if($max==0) echo $maxdiscount;else echo $max;?>">
<?php } 
