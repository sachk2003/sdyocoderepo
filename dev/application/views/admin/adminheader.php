...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("listimage").src = "assets/img/colorlist.jpg";
           }
        	function imgout() {
        		
            document.getElementById("listimage").src = "assets/img/list.gif";
           }
                ...
                <nav class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="http://<?php echo base_url('');?>">Super<span>Dealyo</span></a>
                        </div>
