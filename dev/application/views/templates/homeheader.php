...
<html lang="en">
    <head>
        ...
        <!-- Google Fonts -->    
        <link href="<?php (isset($_SERVER['HTTPS']) ? 'https://' : 'http://').'fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic|Montserrat:400,700'?>" rel='stylesheet' type='text/css'>
